      ...
      <table className="table align-middle table-hover mb-0">
        <thead className="fw-semibold text-body-secondary">
          <tr>
            ...
            <th className="text-center table-heading" style={{ width: '150px' }}>
              User
            </th>
            <th className="text-center table-heading" style={{ width: '120px' }}>
              Country
            </th>
            ...
            <tr key={index}>
              ...
              <td className="text-center">
                <span className="text-center">
                  <Flag code={item.country} alt={item.country} style={{ width: '50px' }} />
                </span>
              </td>
              <td>
