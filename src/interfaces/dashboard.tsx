...
const Dashboard: React.FC<DashboardProps> = ({ dark_mode = false }) => {

    return (
        <Interfaces heading="Dashboard" dark_mode={dark_mode} links={<a href="https://coreui.io/">Home</a>}>
            <div className="d-flex flex-wrap align-items-center">
                <div className={`dashboard-card ${!dark_mode ? 'bg-white' : ''} w-100 p-4`} style={{ minHeight: "400px" }}>
                ...
                <div className="d-flex w-100 p-2 mt-4 gap-5">
