...
const BodyNav = ({ toggle_mode, toggle_nav, dark_mode = false }: BodyNavProps) => {
    ...
    return (
        <div className="container-fluid d-flex align-items-center justify-content-between" style={{ height: "60px", padding: "10px", backgroundColor: dark_mode ? "black": "white", color: dark_mode ? "white" : "black", borderLeft: "1px solid grey", borderBottom: "1px solid grey" }}>
            {
                <div className="d-flex align-items-center justify-content-between gap-3" style={{ backgroundColor: dark_mode ? "black": "white", color: dark_mode ? "white" : "black" }}>
                    {
                        width <= 992 && (
            ...
            <div className="d-flex align-items-center">
                ...
                <button type="button" className="header-toggler" style={{ marginLeft: "25px", border: "none", backgroundColor: dark_mode ? "black" : "white", color: dark_mode ? "white" : "black" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="icon icon-lg" role="img" aria-hidden="true" width={20}>
